...
//on prérempli le formulaire
    ...
    inputTitle.value = cible.querySelector('p').textContent;
  ...
  handleCreateTask: async function(evt)
  {
    ...
    form.addEventListener('submit', async function (evt) {
      ...
      const data = await api.createTask(title, text);
  ...
  handleUpdateTask: function(event)
  {
    ...
    taskId = taskLi.dataset.id;
    const taskTitle = taskLi.p;
    const inputTitle = document.querySelector('#task-title');
    inputTitle.value = taskTitle;
    // console.log(taskId);
   
    console.log(inputTitle.value);
    // const pLiSelected = taskLi.p;
    
    // console.log(pLiSelected);
    // inputTitle.value.textContent = 
